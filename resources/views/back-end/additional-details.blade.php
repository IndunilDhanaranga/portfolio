                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="float-right">
                                <span class="btn btn-warning btn-xs" onclick="addSkills()"><i
                                        class="fa fa-plus"></i></span>
                                <span class="btn btn-warning btn-xs ml-1" id="remove_skill" onclick="removeSkills()"><i
            ...
            <div class="card card-info">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="float-right">
                                <span class="btn btn-warning btn-xs" onclick="addWork()"><i
                                        class="fa fa-plus"></i></span>
                                <span class="btn btn-warning btn-xs ml-1" id="remove_work" onclick="removeWork()"><i
                                        class="fa fa-minus"></i></span>
                            </div>
                        </div>
                    </div>
