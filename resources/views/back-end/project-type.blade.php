                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="float-right">
                                        ...
                                        <span class="btn btn-primary btn-xs" id="remove" onclick="removeTechnology()"><i
            ...
            <tbody>
                @foreach ($project_type as $item)
                    <tr>
                        ...
                        <td>
                            <a href="#edit_project_type" data-project_type="{{$item}}" onclick="editProjectType(this)"><i class="far fa-edit"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
