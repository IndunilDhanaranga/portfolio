...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="{{ config('site-specific.live-path') }}/assets/back-end/default/plugins/fontawesome-free/css/all.min.css">
    <!-- icheck bootstrap -->
    <link rel="stylesheet"
        href="{{ config('site-specific.live-path') }}/assets/back-end/default/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
    <link rel="stylesheet"
...
<body class="hold-transition login-page">
    ...
    <!-- Bootstrap 4 -->
    <script
        src="{{ config('site-specific.live-path') }}/assets/back-end/default/plugins/bootstrap/js/bootstrap.bundle.min.js">
    </script>
    <!-- AdminLTE App -->
